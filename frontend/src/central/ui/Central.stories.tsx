...
const theaters = [
  create(TheaterSchema, { id: 'theater_yongsan', providerId: 'cgv', identity: create(TheaterIdentitySchema, { provider: { case: 'cgv', value: create(CgvTheaterIdentitySchema, { siteNo: '0013' }) } }), region: '서울', name: '용산아이파크몰' }),
  create(TheaterSchema, { id: 'theater_yeongdeungpo', providerId: 'cgv', identity: create(TheaterIdentitySchema, { provider: { case: 'cgv', value: create(CgvTheaterIdentitySchema, { siteNo: '0059' }) } }), region: '서울', name: '영등포' }),
];
...
const policyInput = create(ObservationPolicyInputSchema, { theaterId: theaters[0].id, enabled: true, horizonDays: 14 });
