...
const observationPolicy: AdminObservationPolicy = { id: 'policy_0013', revision: 4, theaterId: theaters[0].id, enabled: true, theater: theaters[0], horizonDays: 14, priority: 70, baselineMinSeconds: 900, baselineMaxSeconds: 1800, demandMinSeconds: 120, demandMaxSeconds: 300, burstMinSeconds: 30, burstMaxSeconds: 90, burstDurationSeconds: 3600, locale: 'ko-KR', timeZone: 'Asia/Seoul', egressPolicyId: 'scan_default', effectiveMode: 'demand', effectivePriority: 90, effectiveMinSeconds: 120, effectiveMaxSeconds: 300, demandActive: true, nextRunAt: '2026-08-12T08:22:00Z', lastFinishedAt: '2026-08-12T08:20:00Z', lastOutcome: 'completed', createdAt: '2026-08-01T00:00:00Z', updatedAt: '2026-08-12T08:20:00Z' };
